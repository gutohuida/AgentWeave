...
def test_alembic_upgrade_head_fresh_file_db(tmp_path) -> None:
    ...
    migration runs cleanly and the version lands at 0020. The full
    ...
    # Verify alembic_version is at the latest revision (0020).
    import aiosqlite
    ...
    assert version == "0020", f"expected alembic_version=0020, got {version}"
...
async def test_init_db_runs_alembic_for_file_db(tmp_path, monkeypatch) -> None:
    ...
    alembic is invoked, and the alembic_version table ends up at 0017.
    """
