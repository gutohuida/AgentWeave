...
def test_alembic_upgrade_head_fresh_file_db(tmp_path) -> None:
    ...
    migration runs cleanly and the version lands at 0021. The full
    ...
    # Verify alembic_version is at the latest revision (0021).
    import aiosqlite
    ...
    assert version == "0021", f"expected alembic_version=0021, got {version}"
