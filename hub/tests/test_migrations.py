...
def test_alembic_upgrade_head_fresh_file_db(tmp_path) -> None:
    ...
    migration runs cleanly and the version lands at 0031. The full
    ...
    # Verify alembic_version is at the latest revision (0031).
    import aiosqlite
    ...
    assert version == "0031", f"expected alembic_version=0031, got {version}"
