...
def test_alembic_upgrade_head_fresh_file_db(tmp_path) -> None:
    ...
    migration runs cleanly and the version lands at 0032. The full
    ...
    # Verify alembic_version is at the latest revision (0032).
    import aiosqlite
    ...
    assert version == "0032", f"expected alembic_version=0032, got {version}"
