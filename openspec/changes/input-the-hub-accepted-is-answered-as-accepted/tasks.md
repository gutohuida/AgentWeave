...
- [ ] 1.6 Each of `messages.py:318`, `agents.py:2257`, `questions.py:212`, `inbound_queue.py:253`: with `schedule_agent` raising, the route answers what it answers when scheduling succeeds, not 500. Record which FAIL today
...
- [ ] 2.4 The four other call sites (D4)
