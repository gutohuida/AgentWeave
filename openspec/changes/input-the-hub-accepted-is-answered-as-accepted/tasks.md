...
- [ ] 1.6 Each of `messages.py:318`, `agents.py:2257`, `questions.py:212`, `inbound_queue.py:253`, and (R2) `accounting.py:78` (two agents queued; the first raises, the second is still scheduled) and `agents.py:2693` (runner rebind): with `schedule_agent` raising, the route answers what it answers when scheduling succeeds, not 500. Record which FAIL today
