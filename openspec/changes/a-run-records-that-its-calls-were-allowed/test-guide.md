# Test guide — a run records that its calls were allowed

## Agent-verifiable

1. **"Asked and allowed" is stored.** Task 1.1 fails today and passes after.
2. **"Never asked" is a different record.** Task 1.2.
...
None. Nothing is shown in the UI by this change.
