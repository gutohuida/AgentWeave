# Test guide — an agent updates a task with what its tool carries
...
None beyond reading the refusal sentence once and judging that it tells an agent what to do instead.
