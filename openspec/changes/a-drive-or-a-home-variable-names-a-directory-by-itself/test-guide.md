...
|---|---|---|
| Another drive is refused | `py -3.11 -m pytest hub/tests/test_permission_approver.py -q` (tasks 1.1, 1.3, 1.5b; Windows) | `Z:`, `Z:foo`, `-Destination:Z:`, `Temp:` refused, naming the word with its colon |
