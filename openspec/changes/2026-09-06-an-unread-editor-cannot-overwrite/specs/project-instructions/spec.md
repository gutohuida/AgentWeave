...
The condition was not there before, and its absence is what this change repairs. The screen used to
promise a pre-filled textarea on every navigation, which is a promise it cannot keep when the read
