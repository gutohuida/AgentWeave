...
- [ ] 1.6a A loop whose agent is paused and whose assigned task has no queued input: the firing does not brief it again (`scheduler.py:1705`'s held set). FAILS today
