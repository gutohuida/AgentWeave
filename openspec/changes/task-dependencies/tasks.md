...
> **8.10 and 8.11 live in the fourth-pass block below, not here.** They were appended there with
> their landing notes on 2026-08-21 while unchecked copies stayed in this list, so both numbers
> existed twice and the section counted 16 tasks when it had 15. The stale copies are removed rather
> than the landed ones, and this note stands in their place rather than a third copy. **8.14 was
> never written** — handoff 0070 and STATE.json both announced it, nothing ever added the line, and
> the liveness cue it described was built as 8.15. The gap in the numbering is real; do not go
> looking for the task, and do not renumber to close it.
...
- [x] 11.8 **The picker earns its place.** Confirm outstanding counts make choosing a board and seeing what is left one act. **Playwright 2026-08-21:** the live picker showed `2/4` and `2/2` on the two fixture boards.
