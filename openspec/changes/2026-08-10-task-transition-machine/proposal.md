...
**Not touched.** No UI work: how the task board *renders* lifecycle and transition history is
Program A/B5, and the fields it would render do not exist until this change lands. No spec format,
no evidence model, no AI.
...
- **Rendering.** No task-board or timeline surface for the new history.
