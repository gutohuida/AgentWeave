...
- [ ] 1.3 Design tests 6, 7, 8, 9, 10, 10b, 10c (the triggers' pre-check, the gate and its initiators). 6, 10 and 10b fail today
...
- [ ] 2.3a `checkpoint_trigger.consider` and `checkpoint_handover.consider_handover`: the budget read before `generate_checkpoint` (design D3a), fail-closed
