...
3. **A flow that cannot be made never blocks approval, the operator can replace a stale agent, and
   a re-approval does not make a second flow, nor calls an ended one working.** Tasks 1.5, 1.6
   (the claim race and the failure after adoption, both of which must answer 200, not 500).
