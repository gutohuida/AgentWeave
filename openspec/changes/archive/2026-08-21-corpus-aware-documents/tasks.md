...
- [ ] 6.6 Enrich the home document's authored narrative — the "thin" complaint is about this prose, and the generated map does not replace it. Not done this iteration; left for a follow-up, per the task list's own separation from 6.1-6.5.
      ...
      **Waived by the operator 2026-08-21 to archive this change.** Not done, and not a defect: the task itself defers this to a follow-up, separately from 6.1-6.5. Carried into `openspec/explorations/2026-08-21-the-corpus-home-narrative.md`.
- [ ] 6.7 **Content backlog, tracked separately:** the eight documents with no usable summary (design D8). They will render as gaps until written. Do not treat writing them as part of this change's completion.
      ...
      **Waived by the operator 2026-08-21 to archive this change.** Waived on the task's own terms — it says in its text "Do not treat writing them as part of this change's completion." The eight summary-less documents remain a content backlog, not unfinished work of this change.
