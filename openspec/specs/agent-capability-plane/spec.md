...
One least-privilege, run-authenticated application contract for agent-caused effects, shared
identically by HTTP, MCP, and ordinary commands. Established by `openspec/changes/agent-capability-plane`.
