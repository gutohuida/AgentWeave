# turn-outcome-visibility Specification

## Purpose

Define how the Hub records and surfaces a run that ends without advancing the deliverable it was
given and without asking the operator anything, determined from structured state alone and never by
inspecting the agent's prose.
