...
class TestMcpSetupCodex:
    """Phase 7 keeps the old setup verb as a non-mutating compatibility notice."""

    def test_mcp_setup_does_not_modify_global_codex_config(self, tmp_path, monkeypatch):
        import argparse
